...
from backend.plugin.oauth2.api.v1.oa_platform import router as oa_platform_router
...
v1.include_router(oa_platform_router, prefix='/oa-platform', tags=['OA Platform OAuth2'])
