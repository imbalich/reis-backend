...
class Settings(BaseSettings):
    ...
    DATA_PERMISSION_MODELS: dict[str, str] = (
        {  # 允许进行数据过滤的 SQLA 模型，它必须以模块字符串的方式定义
    ...
    OAUTH2_OA_PLATFORM_CLIENT_ID: str
    OAUTH2_OA_PLATFORM_CLIENT_SECRET: str
    OAUTH2_OA_PLATFORM_BASE_URL: str = "http://ip:8882"
